...
const AvatarUploadBtn = () => {
    ...
    return (
        <div className='flex flex-col items-center'>
            <div>
                <label htmlFor="fileUpload" className='block cursor-pointer font-semibold dark:text-slate-100 dark:border-2 dark:border-slate-100 px-3 py-2 rounded hover:bg-white hover:text-gray-700'>
                    Add new image
